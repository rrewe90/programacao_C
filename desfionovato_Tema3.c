...
int comparacaoPolulacao = populacao1 >= populacao2;
float comparacaoArea = area1 >= area2;
float comparacaoPib = pib1 >= pib2;
int comparacaoPontoT = pontot1 >= pontot2;
...
printf("PIB: %f \n" , comparacaoPib);
printf("Area: %f \n" , comparacaoArea);
printf(" Super poder: carta A01 venceu\n");
 

// comparação usando o if else 

if(populacao1 > populacao2){
    printf("POPULAÇÃO: CARTA 1 VENCEU\n");
}
else{
    printf("POPULAÇÂO: CARTA 2 VENCEU\n");
}
